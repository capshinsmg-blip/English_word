...
- [x] 단어 데이터 확장 — 현재 7,000개 (원본 테마 192종 → 묶음 테마 87종)
...
- [ ] Phase 4~6 — 새 단어 3,000개 생성 (세션당 ~1,000개, id 7001~10000, 난이도별 rank 지정 + 테마 등록)
  - 우선순위: C1 위주. 각 배치마다 `_RAW_THEMES`에 새 테마(또는 기존 테마에 id 추가) 등록 필수
